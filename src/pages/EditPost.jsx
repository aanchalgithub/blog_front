...
useEffect(() => {
  ...
  const editPost = async (e) => {
    ...
    try {
      const response = await axios.patch(`${process.env.REACT_APP_BASE_URL}/posts/${id}`,postData, { headers : {Authorization :
         `Bearer ${token}`}})
  ...
  return (
    <section className="create-post">
      <div className="container">
        ...
        <form  className="from create-post__form" onSubmit={editPost}>
