...
const createPost = async (e) => {
    ...
    try {
      const response = await axios.postForm(`${process.env.REACT_APP_BASE_URL}/posts`,postData, { headers : {Authorization :
         `Bearer ${token}`}})
  ...
  return (
    <section className="create-post">
      <div className="container">
        ...
        <form  className="from create-post__form" onSubmit={createPost}>
